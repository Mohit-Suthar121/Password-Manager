...
const Password = (props) => {
  return (
    <div className="desc py-2 text-gray-400 border-b border-[#4eff4e10] w-full flex justify-center h-10 items-center pl-6 pr-6 gap-2">
            <span className="w-[95%] truncate flex items-center justify-center">{props.password}</span>
            <span onClick={ ()=>{props.handleCopy(props.password)} } className="cursor-pointer group">
                <svg
